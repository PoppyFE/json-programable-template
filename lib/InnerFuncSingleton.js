    ...
    getResult(originalValue,funcName,value){
        ...
        if( // 分发到外部函数
            ...
            if(staticJsonModel.length > 0){
                return this.cb[funcName](..._value, staticJsonModel[0], originalValue);
            }else{
                return this.cb[funcName](..._value,originalValue);
            }
        } else {
            // 分发到内部函数
            ...
            return innerFuncDispatch(_funcName,_value,originalValue);
        }
        ...
        //     index = require('./index/functionIndex');
        //     if(index[_funcName] === undefined){
        //         throw new Error("Inner function "  + _funcName + " is not found in function index page");
        //     }
        //     return innerFuncDispatch(_funcName,_value,originalValue);
        // }
        //     // 分发到外部函数
        // else {
        //     if(this.cb[funcName] === undefined){
        //         throw new Error("Outer function "  + funcName + " is undefined");
        //     }
        //
        //     return this.cb[funcName](..._value, originalValue);
        // }
