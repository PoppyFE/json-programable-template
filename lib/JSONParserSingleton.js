...
class JSONParserSingleton {
    ...
    static getInstance(cb) {
        if (this.instance === undefined) {
            this.instance = new JSONParserSingleton(cb);
        }
    ...
    _funcSplit(originalValue, arrValue){
        ...
        if(
            arr.length === 2
            || arr.length === 1){
            originalValue = InnerFuncSingleton.getInstance(this.cb).getResult(originalValue,arr[0],arr[1]);
...
module.exports = JSONParserSingleton;
